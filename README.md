...
Because the marketplace data is stored in a separate repository, you must initialize submodules when cloning to ensure the search engine has data to parse.
